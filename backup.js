...
$(document).ready(function () {
    ...
    function gameScreen() {
        ...
        $('#gameContent').append('<div id="guesses"> <h4 class="white-text center"> Chữ đoán sai </h4> </div>');
        ...
        for (i = 0; i < numberOfTiles; i++) {
            ...
            $('#wordHolder').append('<h3 class="white btn-large black-text" id=t' + i + '></h3>' + ' ');
        }

        $('#clueHolder').append("<h3 class= 'white-text'>Gợi ý: " + currentClue + "</h3>");
    ...
    function victoryMessage() {
        ...
        $('#feedback').append("<h3 class='white-text center'> Đúng Rồi! </h3> <br><div id='nextlv' class='green card hoverable animated bounceInRight white-text center'> <h3> Tiếp Tục </h3> </div>");
        $('#nextlv').on("click", function () {
            score = score + 1;
            gameScreen()
			// Firebase.goOffline();
    ...
    function defeatMessage() {
        $(document).off("keyup", handleKeyUp);
        $('#sentscore').append("<div id='sentfb' class='teal card hoverable animated bounceInRight white-text center'><h3>Gửi Điểm</h3> </div> ");
        $('#feedback').append("<h3 class='white-text center'>Bạn thua rồi ! <br> Đáp án = <mark>" + currentWord.toUpperCase() + " </mark> </h3>  <br>  <div id='replay' class='yellow card hoverable animated bounceInRight black-text center'><h3>Chơi lại</h3> </div>");
